...
export default function OpsDashboard() {
  ...
  // Stats from backend (ops view: pressure, decisions, volume)
  ...
  return (
    <div style={styles.page}>
      <header style={styles.header}>
        ...
        <p style={styles.subtitle}>Hospital flow · pressure & decisions · Agentic AI</p>
        ...
        <>
          <section style={styles.stats}>
            ...
            <div style={styles.statGrid}>
              ...
              <div style={styles.statCard}>
                <div style={styles.statValue}>Decisions</div>
          ...
          <section style={styles.patients}>
            <h2 style={styles.sectionTitle}>Patients — click for LLM summary (ops view)</h2>
              ...
              {outputs.map((o) => (
                ...
                >
                  ...
                  <span style={styles.chipMeta}>
                    {o.decision} · pressure {Number(o.pressure)?.toFixed(2) ?? "—"}
                  </span>
                </button>
              ))}
            </div>
        ...
        <div style={styles.modalOverlay} onClick={closeModal}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              <h3>Patient summary — {selectedRecord.patient_id} (Ops)</h3>
